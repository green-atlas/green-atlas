  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-100 dark:from-[#0a0a0a] dark:to-[#121212]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold mb-8">Green Atlas – Privacy Policy</h1>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none [&_a]:text-[var(--eu-blue)] dark:[&_a]:text-[var(--eu-yellow)] [&_a:hover]:underline">
          <p className="text-gray-700 dark:text-gray-300 mb-8">
            This privacy policy will explain how the Green Atlas uses the personal
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              The Green Atlas website contains links to other websites. Our privacy
