  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="absolute right-0 top-0 p-4 z-20">
        <Link
          href="https://github.com/green-atlas/green-atlas"
          target="_blank"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1 space-y-6">
              <div className="flex items-center gap-4">
                <Image
                  src="/europe-logo.svg"
                  alt="Europe Green Atlas Logo"
                  width={60}
                  height={60}
                  className="rounded-full"
                />
                <h1 className="text-4xl md:text-6xl font-bold">
                  <span className="text-[var(--eu-yellow)]">Green</span> Atlas
                </h1>
              </div>
              <p className="text-xl md:text-2xl max-w-2xl">
                Discover European sustainability & ESG organizations
              </p>
              <p className="text-lg opacity-80 max-w-2xl">
                Your map to navigate the European green landscape
              </p>
              <div className="pt-4">
                <a
                  href="#climate-action"
          ...
          <div className="md:hidden flex justify-between items-center py-2 px-4">
            <div className="flex items-center gap-2">
              <Image
                ...
                className="rounded-full"
              />
              <span className="font-bold">Green Atlas</span>
            </div>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <section className="text-center max-w-3xl mx-auto mb-8 px-4 md:px-8">
            <h2 className="text-3xl font-bold mb-4">
              Welcome to the European Green Atlas
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Explore our collection of European organizations and initiatives driving sustainability,
              ESG governance, and social impact. Find partners for EU funding applications
              or discover organizations aligned with your green mission.
            </p>
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
              All organizations are categorized by their sustainability focus, with
              country flags indicating headquarters location. Perfect for Förderanträge research.
            </p>

            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <ActionButton
                href="https://github.com/green-atlas/green-atlas/issues/new?template=suggest-organization.yml"
                icon={
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                label="Add Organization on GitHub"
                variant="primary"
              />
              <ActionButton
                href="#newsletter"
            ...
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
              No GitHub account? Suggest an organization via email at{' '}
              <a
                href="mailto:contact@greenatlas.eu"
                className="font-medium text-[var(--eu-blue)] dark:text-white/90 hover:underline"
              >
                contact@greenatlas.eu
              </a>
            </p>
          </section>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              ...
              <p className="mt-2 text-sm text-white/70">
                Mapping the European sustainability landscape
              </p>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-xl">🇪🇺🌱</span>
              <span className="text-sm">Made for a sustainable Europe</span>
            </div>
          </div>
          <div className="mt-8 pt-6 border-t border-white/20 text-center text-sm text-white/60">
            © {new Date().getFullYear()} Green Atlas • GPL Licensed • Contributions
            welcome
          </div>
